...
server.deserializeClient(function (id, callback) {
    client_1.Client.findOne({ _id: id }, function (err, client) {
        if (err)
            return callback(err);
...
server.exchange(oauth2orize.exchange.code(function (client, code, redirectUri, callback) {
    code_1.Code.findOne({ value: code }, function (err, authCode) {
        if (err)
            return callback(err);
        if (authCode === null)
...
//# sourceMappingURL=../../build/controllers/oauth2.js.map
